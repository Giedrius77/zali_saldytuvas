    ...
    def __init__(self):
        ...
        if contents and len(contents) > 0:
            for product_dict in contents:
                self.contents.append(Product(product_dict['name'], product_dict['quantity'])) # , product_dict['unit of measurement'] - isimta

    def save(self):
        with open('zaliu_fridge.json', 'w', encoding='utf-8') as fridge_file:
            contents = []
